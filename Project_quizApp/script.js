...
document.querySelector(".submit-answer").addEventListener("click", function () {
  ...
  if (selectedOption) {
    if (
      ...
      window[lang][countQues].choices[
        window[lang][countQues].answer - 1
      ]
    ) {
      score += 10;
...
document.querySelector(".view-results").addEventListener("click", function () {
  ...
  var solvedQuestions = countQues + 1;
  var rightAnswers = Math.floor(score / 10);
  var wrongAnswers = solvedQuestions - rightAnswers;

  document.querySelector(".solved-ques-no").textContent =
    "You Solved " + solvedQuestions + " questions of " + lang.charAt(0).toUpperCase() + lang.slice(1, -8);

  document.querySelector(".right-wrong").textContent =
    rightAnswers + " Were Right and " + wrongAnswers + " were Wrong";

  document.getElementById("display-final-score").textContent =
  ...
  if (score >= 50) {
    ...
    document.querySelector(".remark").textContent =
      "Remark: Good, but keep improving.";
  } else {
    document.querySelector(".remark").textContent =
      "Remark: Satisfactory, Keep trying.";
  }
});
...
document.getElementById("restart").addEventListener("click", function () {
  ...
  document.querySelector(".quiz").style.display = "none";
  document.querySelector(".final-result").style.display = "none";
  document.querySelector(".choose-lang").style.display = "unset";
  document.querySelector(".view-results").style.display = "none";
});